...
public class ToDoListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * if(!isConnectedtoNet(ToDoListActivity.this)) { AlertDialog.Builder
		 ...
		 * Intent(Intent.ACTION_MAIN); i.addCategory(Intent.CATEGORY_HOME);
					...
					public void onDismiss(ListView listView,
						...
						for (final int position : reverseSortedPositions) {
							...
							ParseQuery<ParseObject> query = new ParseQuery<ParseObject>(
									"todoItems");
							// query.whereEqualTo("itemName",
							// todolist.getItemAtPosition(position));
							...
							Toast.makeText(getBaseContext(),
									"Done with this task", Toast.LENGTH_SHORT)
									.show();
						}
		...
		mSwipeRefreshLayout.setColorScheme(R.color.blue_200, R.color.blue_400,
				R.color.blue_600, R.color.blue_800);
		mSwipeRefreshLayout.setOnRefreshListener(new OnRefreshListener() {

			@Override
			public void onRefresh() {
				// TODO Auto-generated method stub
				Toast.makeText(getBaseContext(), "Retrieving Todos",
		...
		fab.setFabDrawable(getResources().getDrawable(R.drawable.ic_action_new));
		fab.showFab();
		fab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent addtodoIntent = new Intent(ToDoListActivity.this,
						AddListItem.class);
